...
public class Automovil implements Comparable<Automovil> {
        ...
        public static final String COLOR_AMARILO = "Amarillo";
        ...
        public String verDetalle() {
            ...
            if (conductor != null) {
                detalle += "\nConductor: " + this.getConductor(); //Preguntar por que no se usa this.conductor.getConductor();
            }


            //Agregando la condicion para imprimir el estanque
            if(estanque != null){
                detalle += "\nEstanque: " + this.estanque.getCapacidad();
            }
